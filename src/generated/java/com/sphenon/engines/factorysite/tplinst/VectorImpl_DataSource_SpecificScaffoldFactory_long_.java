...
public class VectorImpl_DataSource_SpecificScaffoldFactory_long_
  implements Vector_SpecificScaffoldFactory_long_, ManagedResource {
    private com.sphenon.basics.data.DataSource<Vector> vector_source;

    public VectorImpl_DataSource_SpecificScaffoldFactory_long_ (CallContext context, com.sphenon.basics.data.DataSource<Vector> vector_source) {
        this.vector_source = vector_source;
    }

    static public VectorImpl_DataSource_SpecificScaffoldFactory_long_ create (CallContext context, com.sphenon.basics.data.DataSource<Vector> vector_source) {
        return new VectorImpl_DataSource_SpecificScaffoldFactory_long_(context, vector_source);
    }

    public SpecificScaffoldFactory get          (CallContext context, long index) throws DoesNotExist {
        try {
            return (SpecificScaffoldFactory) vector_source.get(context).elementAt((int) index);
