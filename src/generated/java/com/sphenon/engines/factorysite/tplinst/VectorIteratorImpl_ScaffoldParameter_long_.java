...
public class VectorIteratorImpl_ScaffoldParameter_long_
    implements IteratorItemIndex_ScaffoldParameter_long_,
               Cloneable
{
    private ReadOnlyVector_ScaffoldParameter_long_ vector;
    private long current_index;

    public VectorIteratorImpl_ScaffoldParameter_long_ (CallContext context, ReadOnlyVector_ScaffoldParameter_long_ vector) {
        this.vector = vector;
    ...
    public VectorIteratorImpl_ScaffoldParameter_long_ clone(CallContext context) {
        try {
            return (VectorIteratorImpl_ScaffoldParameter_long_) super.clone();
