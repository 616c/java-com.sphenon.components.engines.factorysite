...
@UIId("")
@UIName("")
@UIClassifier("Vector_Pair_BuildText_String__")
@UIParts("js:instance.getIterable(context)")
public interface Vector_Pair_BuildText_String__long_
  extends ReadOnlyVector_Pair_BuildText_String__long_,
          WriteVector_Pair_BuildText_String__long_
          , GenericVector<Pair_BuildText_String_>
          , GenericIterable<Pair_BuildText_String_>
{
    ...
    public ReferenceToMember_Pair_BuildText_String__long_ReadOnlyVector_Pair_BuildText_String__long__  getReference    (CallContext context, long index) throws DoesNotExist;
    public ReferenceToMember_Pair_BuildText_String__long_ReadOnlyVector_Pair_BuildText_String__long__  tryGetReference (CallContext context, long index);
