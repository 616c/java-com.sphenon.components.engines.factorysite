...
public interface Iterator_DataSourceConnector_
    extends com.sphenon.basics.many.Iterator<DataSourceConnector>
{
    ...
    public Iterator_DataSourceConnector_ clone(CallContext context);
}
