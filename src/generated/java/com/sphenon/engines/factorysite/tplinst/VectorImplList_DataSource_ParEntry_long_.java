...
public class VectorImplList_DataSource_ParEntry_long_
  implements Vector_ParEntry_long_, Changing, ManagedResource {
    ...
    protected VectorImplList_DataSource_ParEntry_long_ (CallContext context, DataSource_List_ vector_source) {
    ...
    static public VectorImplList_DataSource_ParEntry_long_ create (CallContext context, DataSource_List_ vector_source) {
        return new VectorImplList_DataSource_ParEntry_long_(context, vector_source);
    }

    public ParEntry get          (CallContext context, long index) throws DoesNotExist {
        try {
            return (ParEntry) vector_source.get(context).get((int) index);
