...
public class Factory_Map_FactorySite_String_
{
    private String[] names;
    private FactorySite[] values;

    public Map_FactorySite_String_ create (CallContext context) {
        Map_FactorySite_String_ map = new MapImpl_FactorySite_String_(context);
    ...
    public void set_ParametersAtOnce(CallContext call_context, String[] names, FactorySite[] values) {
