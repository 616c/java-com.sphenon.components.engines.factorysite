...
public class VectorImplList_DataSource_Scaffold_long_
  implements Vector_Scaffold_long_, Changing, ManagedResource {
    ...
    protected VectorImplList_DataSource_Scaffold_long_ (CallContext context, DataSource_List_ vector_source) {
    ...
    static public VectorImplList_DataSource_Scaffold_long_ create (CallContext context, DataSource_List_ vector_source) {
        return new VectorImplList_DataSource_Scaffold_long_(context, vector_source);
    }

    public Scaffold get          (CallContext context, long index) throws DoesNotExist {
        try {
            return (Scaffold) vector_source.get(context).get((int) index);
