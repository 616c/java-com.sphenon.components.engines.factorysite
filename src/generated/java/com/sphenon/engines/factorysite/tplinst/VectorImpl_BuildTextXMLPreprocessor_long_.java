...
public class VectorImpl_BuildTextXMLPreprocessor_long_
  implements Vector_BuildTextXMLPreprocessor_long_,
             VectorOptimized<BuildTextXMLPreprocessor>,
             Dumpable,
             ManagedResource
 {
    private java.util.Vector vector;

    protected VectorImpl_BuildTextXMLPreprocessor_long_ (CallContext context) {
        vector = new java.util.Vector(4);
    }

    static public VectorImpl_BuildTextXMLPreprocessor_long_ create (CallContext context) {
        return new VectorImpl_BuildTextXMLPreprocessor_long_(context);
    }

    protected VectorImpl_BuildTextXMLPreprocessor_long_ (CallContext context, java.util.Vector vector) {
        this.vector = vector;
    }

    static public VectorImpl_BuildTextXMLPreprocessor_long_ create (CallContext context, java.util.Vector vector) {
        return new VectorImpl_BuildTextXMLPreprocessor_long_(context, vector);
    }
    ...
    public BuildTextXMLPreprocessor get          (CallContext context, long index) throws DoesNotExist {
        try {
            return (BuildTextXMLPreprocessor) vector.elementAt((int) index);
    ...
    public boolean contains(CallContext context, BuildTextXMLPreprocessor item) {
        return this.vector.contains(item);
    }

    public boolean removeFirst(CallContext context, BuildTextXMLPreprocessor item) {
        return this.vector.remove(item);
    }

    public void removeAll(CallContext context, BuildTextXMLPreprocessor item, VectorOptimized.Notifier<BuildTextXMLPreprocessor> notifier) {
