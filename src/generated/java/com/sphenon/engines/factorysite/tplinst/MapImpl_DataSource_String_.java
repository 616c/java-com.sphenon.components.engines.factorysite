...
public class MapImpl_DataSource_String_
  implements Map_DataSource_String_
{
    private java.util.Hashtable map;

    public MapImpl_DataSource_String_ (CallContext context) {
        map = new java.util.Hashtable ();
    }

    public MapImpl_DataSource_String_ (CallContext context, java.util.Hashtable map ) {
        this.map = map;
    }
    ...
    public DataSource tryGet  (CallContext context, String index) {
        DataSource typeditem = (DataSource) map.get(index);
        return typeditem;
    }
    ...
    public MapReferenceToMember_DataSource_String_ getReference (CallContext context, String index) throws DoesNotExist {
        ...
        return new MapReferenceToMember_DataSource_String_(context, this, index);
    }
    ...
    public IteratorItemIndex_DataSource_String_ getNavigator (CallContext context) {
        return new MapIteratorImpl_DataSource_String_ (context, map, this);
    }
