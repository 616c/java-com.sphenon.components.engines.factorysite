...
public class VectorReferenceToMember_Pair_BuildText_String__long_
    implements ReferenceToMember_Pair_BuildText_String__long_ReadOnlyVector_Pair_BuildText_String__long__
{
    private ReadOnlyVector_Pair_BuildText_String__long_ vector;
    private long                          index;

    public VectorReferenceToMember_Pair_BuildText_String__long_ (CallContext context, ReadOnlyVector_Pair_BuildText_String__long_ vector, long index) {
        this.vector = vector;
        this.index  = index;
    ...
    public ReadOnlyVector_Pair_BuildText_String__long_ getContainer (CallContext context) {
        return this.vector;
    }
    ...
    public Pair_BuildText_String_ get (CallContext context) {
            try {
    ...
    public boolean equals (Object object) {
        ...
        if (! (object instanceof VectorReferenceToMember_Pair_BuildText_String__long_)) return false;
        if (((VectorReferenceToMember_Pair_BuildText_String__long_) object).vector != this.vector) return false;
        if (((VectorReferenceToMember_Pair_BuildText_String__long_) object).index  != this.index ) return false;
        return true;
    }
