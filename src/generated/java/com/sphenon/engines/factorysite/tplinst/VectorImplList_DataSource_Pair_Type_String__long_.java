...
public class VectorImplList_DataSource_Pair_Type_String__long_
  implements Vector_Pair_Type_String__long_, Changing, ManagedResource {
    ...
    protected VectorImplList_DataSource_Pair_Type_String__long_ (CallContext context, DataSource_List_ vector_source) {
    ...
    static public VectorImplList_DataSource_Pair_Type_String__long_ create (CallContext context, DataSource_List_ vector_source) {
        return new VectorImplList_DataSource_Pair_Type_String__long_(context, vector_source);
    }

    public Pair_Type_String_ get          (CallContext context, long index) throws DoesNotExist {
        try {
            return (Pair_Type_String_) vector_source.get(context).get((int) index);
