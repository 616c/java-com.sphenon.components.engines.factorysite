...
public class MapIteratorImpl_FactorySite_String_
    implements IteratorItemIndex_FactorySite_String_
{
    private Map_FactorySite_String_ map_t;
    private java.util.Hashtable map;
    private java.util.Set entry_set;
    private java.util.Iterator iterator;
    private java.util.Map.Entry me;

    public MapIteratorImpl_FactorySite_String_ (CallContext context, java.util.Hashtable map, Map_FactorySite_String_ map_t) {
        this.map_t = map_t;
        this.map = map;
    ...
    public FactorySite getCurrent (CallContext context) throws DoesNotExist {
        if ( ! canGetCurrent(context)) { DoesNotExist.createAndThrow(context); }
        return (FactorySite) me.getValue();
    }

    public FactorySite tryGetCurrent (CallContext context) {
        if ( ! canGetCurrent(context)) { return null; }
        return (FactorySite) me.getValue();
    }
    ...
    public Reference_FactorySite_ getReferenceToCurrent (CallContext context) throws DoesNotExist {
        return map_t.getReference(context, this.getCurrentIndex(context));
    }

    public Reference_FactorySite_ tryGetReferenceToCurrent (CallContext context) {
        if ( ! canGetCurrent(context)) { return null; }
        return map_t.tryGetReference(context, this.tryGetCurrentIndex(context));
    }

    public MapIteratorImpl_FactorySite_String_ clone(CallContext context) {
