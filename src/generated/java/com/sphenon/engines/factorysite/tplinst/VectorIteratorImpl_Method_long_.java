...
public class VectorIteratorImpl_Method_long_
    implements IteratorItemIndex_Method_long_,
               Cloneable
{
    private ReadOnlyVector_Method_long_ vector;
    private long current_index;

    public VectorIteratorImpl_Method_long_ (CallContext context, ReadOnlyVector_Method_long_ vector) {
        this.vector = vector;
    ...
    public Method getCurrent    (CallContext context) throws DoesNotExist {
        return vector.get(context, this.current_index);
    }

    public Method tryGetCurrent (CallContext context) {
    ...
    public Reference_Method_ getReferenceToCurrent (CallContext context) throws DoesNotExist {
        return vector.getReference(context, this.current_index);
    }

    public Reference_Method_ tryGetReferenceToCurrent (CallContext context) {
        return vector.tryGetReference(context, this.current_index);
    }

    public VectorIteratorImpl_Method_long_ clone(CallContext context) {
        try {
            return (VectorIteratorImpl_Method_long_) super.clone();
