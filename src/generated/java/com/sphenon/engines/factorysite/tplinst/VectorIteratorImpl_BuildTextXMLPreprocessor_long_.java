...
public class VectorIteratorImpl_BuildTextXMLPreprocessor_long_
    implements IteratorItemIndex_BuildTextXMLPreprocessor_long_,
               Cloneable
{
    private ReadOnlyVector_BuildTextXMLPreprocessor_long_ vector;
    private long current_index;

    public VectorIteratorImpl_BuildTextXMLPreprocessor_long_ (CallContext context, ReadOnlyVector_BuildTextXMLPreprocessor_long_ vector) {
        this.vector = vector;
    ...
    public Reference_BuildTextXMLPreprocessor_ getReferenceToCurrent (CallContext context) throws DoesNotExist {
        return vector.getReference(context, this.current_index);
    }

    public Reference_BuildTextXMLPreprocessor_ tryGetReferenceToCurrent (CallContext context) {
        return vector.tryGetReference(context, this.current_index);
    }

    public VectorIteratorImpl_BuildTextXMLPreprocessor_long_ clone(CallContext context) {
        try {
            return (VectorIteratorImpl_BuildTextXMLPreprocessor_long_) super.clone();
