...
public class MapIteratorImpl_Scaffold_String_
    implements IteratorItemIndex_Scaffold_String_
{
    private Map_Scaffold_String_ map_t;
    private java.util.Hashtable map;
    private java.util.Set entry_set;
    private java.util.Iterator iterator;
    private java.util.Map.Entry me;

    public MapIteratorImpl_Scaffold_String_ (CallContext context, java.util.Hashtable map, Map_Scaffold_String_ map_t) {
        this.map_t = map_t;
        this.map = map;
    ...
    public MapIteratorImpl_Scaffold_String_ clone(CallContext context) {
