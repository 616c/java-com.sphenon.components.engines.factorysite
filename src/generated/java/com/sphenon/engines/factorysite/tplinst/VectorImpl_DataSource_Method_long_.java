...
public class VectorImpl_DataSource_Method_long_
  implements Vector_Method_long_, ManagedResource {
    private com.sphenon.basics.data.DataSource<Vector> vector_source;

    public VectorImpl_DataSource_Method_long_ (CallContext context, com.sphenon.basics.data.DataSource<Vector> vector_source) {
        this.vector_source = vector_source;
    }

    static public VectorImpl_DataSource_Method_long_ create (CallContext context, com.sphenon.basics.data.DataSource<Vector> vector_source) {
        return new VectorImpl_DataSource_Method_long_(context, vector_source);
    }

    public Method get          (CallContext context, long index) throws DoesNotExist {
        try {
            return (Method) vector_source.get(context).elementAt((int) index);
    ...
    public Method set          (CallContext context, long index, Method item) {
        ...
        return (Method) vector_source.get(context).set((int) index, item);
    }
    ...
    public Method unset        (CallContext context, long index) {
        try {
            return (Method) vector_source.get(context).remove((int) index);
        } catch (ArrayIndexOutOfBoundsException e) {
