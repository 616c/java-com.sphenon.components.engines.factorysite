...
public class MapIteratorImpl_BuildTextExpansion_String_
    implements IteratorItemIndex_BuildTextExpansion_String_
{
    private Map_BuildTextExpansion_String_ map_t;
    private java.util.Hashtable map;
    private java.util.Set entry_set;
    private java.util.Iterator iterator;
    private java.util.Map.Entry me;

    public MapIteratorImpl_BuildTextExpansion_String_ (CallContext context, java.util.Hashtable map, Map_BuildTextExpansion_String_ map_t) {
        this.map_t = map_t;
        this.map = map;
    ...
    public BuildTextExpansion getCurrent (CallContext context) throws DoesNotExist {
        if ( ! canGetCurrent(context)) { DoesNotExist.createAndThrow(context); }
        return (BuildTextExpansion) me.getValue();
    }

    public BuildTextExpansion tryGetCurrent (CallContext context) {
        if ( ! canGetCurrent(context)) { return null; }
        return (BuildTextExpansion) me.getValue();
    }
    ...
    public Reference_BuildTextExpansion_ getReferenceToCurrent (CallContext context) throws DoesNotExist {
        return map_t.getReference(context, this.getCurrentIndex(context));
    }

    public Reference_BuildTextExpansion_ tryGetReferenceToCurrent (CallContext context) {
        if ( ! canGetCurrent(context)) { return null; }
        return map_t.tryGetReference(context, this.tryGetCurrentIndex(context));
    }

    public MapIteratorImpl_BuildTextExpansion_String_ clone(CallContext context) {
