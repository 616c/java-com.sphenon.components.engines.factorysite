...
public class OMapImpl_Vector_Pair_BuildText_String__long__Type_
  implements OMap_Vector_Pair_BuildText_String__long__Type_
{
    protected java.util.Hashtable map;

    protected class Entry {
        private Vector_Pair_BuildText_String__long_                     actual_item;
        private Vector_Pair_BuildText_String__long_                     cached_item;
        private java.util.Vector             child_entries;
        private java.util.Vector             parent_entries;
        private OMapImpl_Vector_Pair_BuildText_String__long__Type_ omap;
        private Type                    index;
        private int                          path_length;
        private Type                    cached_index;

        public Entry (CallContext context, OMapImpl_Vector_Pair_BuildText_String__long__Type_ omap, Type index) {
            this.omap = omap;
            this.index = index;
        ...
        public void setItem(CallContext context, Vector_Pair_BuildText_String__long_ item) {
        ...
        public Vector_Pair_BuildText_String__long_ getItem(CallContext context) {
        ...
        public void update (CallContext context) {
            ...
            for (int i=0; i < this.parent_entries.size(); i++) {
                ...
                Vector_Pair_BuildText_String__long_ parent_item = parent_entry.getItem(context);
                if (parent_item != null) {
    ...
    public OMapImpl_Vector_Pair_BuildText_String__long__Type_ (CallContext context)
    {
        map = new java.util.Hashtable ();
    }

    public OMapImpl_Vector_Pair_BuildText_String__long__Type_ (CallContext context, java.util.Hashtable map )
    {
        this.map = map;
    }
    ...
    {
        Vector_Pair_BuildText_String__long_ item = this.tryGet(context, index);
    ...
    public void     set     (CallContext context, Type index, Vector_Pair_BuildText_String__long_ item)
    {
        Entry entry = this._getEntry(context, index);
        entry.setItem(context, item);
    }

    public void     add     (CallContext context, Type index, Vector_Pair_BuildText_String__long_ item) throws AlreadyExists
    {
        Entry entry = this._getEntry(context, index);
    ...
    public void     replace (CallContext context, Type index, Vector_Pair_BuildText_String__long_ item) throws DoesNotExist
    {
        Entry entry = this._getEntry(context, index);
