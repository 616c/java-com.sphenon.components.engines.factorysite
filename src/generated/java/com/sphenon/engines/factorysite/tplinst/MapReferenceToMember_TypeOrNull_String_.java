...
public class MapReferenceToMember_TypeOrNull_String_
    implements ReferenceToMember_TypeOrNull_String_Map_TypeOrNull_String__
{
    private Map_TypeOrNull_String_    map;
    private String                  index;

    public MapReferenceToMember_TypeOrNull_String_ (CallContext context, Map_TypeOrNull_String_ map, String index) {
        this.map    = map;
        this.index  = index;
    ...
    public TypeOrNull get (CallContext context) {
        try {
    ...
    public boolean equals (Object object) {
        ...
        if (! (object instanceof MapReferenceToMember_TypeOrNull_String_)) return false;
        if (((MapReferenceToMember_TypeOrNull_String_) object).map != this.map) return false;
        if (((MapReferenceToMember_TypeOrNull_String_) object).index  != this.index ) return false;
        return true;
    }
