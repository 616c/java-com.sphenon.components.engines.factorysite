...
import com.sphenon.basics.many.returncodes.*;
 ...
 public class Pair_FactorySite_String_ {
    private FactorySite item1;
    private String item2;

    public Pair_FactorySite_String_ (CallContext context, FactorySite item1, String item2) {
        this.item1 = item1;
        this.item2 = item2;
    }

    public FactorySite getItem1(CallContext context) { return item1; }
    
    public void setItem1(CallContext context, FactorySite item1) { this.item1 = item1; }
