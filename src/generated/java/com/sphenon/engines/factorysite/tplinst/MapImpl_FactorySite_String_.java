...
public class MapImpl_FactorySite_String_
  implements Map_FactorySite_String_
{
    private java.util.Hashtable map;

    public MapImpl_FactorySite_String_ (CallContext context) {
        map = new java.util.Hashtable ();
    }

    public MapImpl_FactorySite_String_ (CallContext context, java.util.Hashtable map ) {
        this.map = map;
    }
    ...
    public FactorySite get     (CallContext context, String index) throws DoesNotExist {
        ...
        return (FactorySite) item;
    }

    public FactorySite tryGet  (CallContext context, String index) {
        FactorySite typeditem = (FactorySite) map.get(index);
        return typeditem;
    }
    ...
    public MapReferenceToMember_FactorySite_String_ getReference (CallContext context, String index) throws DoesNotExist {
        ...
        return new MapReferenceToMember_FactorySite_String_(context, this, index);
    }
    ...
    public IteratorItemIndex_FactorySite_String_ getNavigator (CallContext context) {
        return new MapIteratorImpl_FactorySite_String_ (context, map, this);
    }
