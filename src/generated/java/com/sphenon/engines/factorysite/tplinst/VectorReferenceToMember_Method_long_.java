...
public class VectorReferenceToMember_Method_long_
    implements ReferenceToMember_Method_long_ReadOnlyVector_Method_long__
{
    private ReadOnlyVector_Method_long_ vector;
    private long                          index;

    public VectorReferenceToMember_Method_long_ (CallContext context, ReadOnlyVector_Method_long_ vector, long index) {
        this.vector = vector;
        this.index  = index;
    ...
    public ReadOnlyVector_Method_long_ getContainer (CallContext context) {
        return this.vector;
    }
    ...
    public Method get (CallContext context) {
            try {
    ...
    public boolean equals (Object object) {
        ...
        if (! (object instanceof VectorReferenceToMember_Method_long_)) return false;
        if (((VectorReferenceToMember_Method_long_) object).vector != this.vector) return false;
        if (((VectorReferenceToMember_Method_long_) object).index  != this.index ) return false;
        return true;
    }
