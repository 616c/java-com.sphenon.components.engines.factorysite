...
public class Factory_Map_Scaffold_String_
{
    private String[] names;
    private Scaffold[] values;

    public Map_Scaffold_String_ create (CallContext context) {
        Map_Scaffold_String_ map = new MapImpl_Scaffold_String_(context);
