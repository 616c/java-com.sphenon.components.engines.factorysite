...
public class MapReferenceToMember_FactorySite_String_
    implements ReferenceToMember_FactorySite_String_Map_FactorySite_String__
{
    private Map_FactorySite_String_    map;
    private String                  index;

    public MapReferenceToMember_FactorySite_String_ (CallContext context, Map_FactorySite_String_ map, String index) {
        this.map    = map;
        this.index  = index;
    ...
    public Map_FactorySite_String_ getContainer (CallContext context) {
        return this.map;
    }
    ...
    public FactorySite get (CallContext context) {
        try {
    ...
    public boolean equals (Object object) {
        ...
        if (! (object instanceof MapReferenceToMember_FactorySite_String_)) return false;
        if (((MapReferenceToMember_FactorySite_String_) object).map != this.map) return false;
        if (((MapReferenceToMember_FactorySite_String_) object).index  != this.index ) return false;
        return true;
    }
