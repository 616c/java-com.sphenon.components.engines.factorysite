...
public class VectorReferenceToMember_ScaffoldParameter_long_
    implements ReferenceToMember_ScaffoldParameter_long_ReadOnlyVector_ScaffoldParameter_long__
{
    private ReadOnlyVector_ScaffoldParameter_long_ vector;
    private long                          index;

    public VectorReferenceToMember_ScaffoldParameter_long_ (CallContext context, ReadOnlyVector_ScaffoldParameter_long_ vector, long index) {
        this.vector = vector;
        this.index  = index;
    ...
    public ReadOnlyVector_ScaffoldParameter_long_ getContainer (CallContext context) {
        return this.vector;
    }
    ...
    public boolean equals (Object object) {
        ...
        if (! (object instanceof VectorReferenceToMember_ScaffoldParameter_long_)) return false;
        if (((VectorReferenceToMember_ScaffoldParameter_long_) object).vector != this.vector) return false;
        if (((VectorReferenceToMember_ScaffoldParameter_long_) object).index  != this.index ) return false;
        return true;
    }
