...
public class VectorImpl_DataSource_Pair_BuildText_String__long_
  implements Vector_Pair_BuildText_String__long_, ManagedResource {
    private com.sphenon.basics.data.DataSource<Vector> vector_source;

    public VectorImpl_DataSource_Pair_BuildText_String__long_ (CallContext context, com.sphenon.basics.data.DataSource<Vector> vector_source) {
        this.vector_source = vector_source;
    }

    static public VectorImpl_DataSource_Pair_BuildText_String__long_ create (CallContext context, com.sphenon.basics.data.DataSource<Vector> vector_source) {
        return new VectorImpl_DataSource_Pair_BuildText_String__long_(context, vector_source);
    }

    public Pair_BuildText_String_ get          (CallContext context, long index) throws DoesNotExist {
        try {
            return (Pair_BuildText_String_) vector_source.get(context).elementAt((int) index);
