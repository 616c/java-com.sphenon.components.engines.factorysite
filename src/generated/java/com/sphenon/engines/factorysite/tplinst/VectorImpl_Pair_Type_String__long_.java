...
public class VectorImpl_Pair_Type_String__long_
  implements Vector_Pair_Type_String__long_,
             VectorOptimized<Pair_Type_String_>,
             Dumpable,
             ManagedResource
 {
    private java.util.Vector vector;

    protected VectorImpl_Pair_Type_String__long_ (CallContext context) {
        vector = new java.util.Vector(4);
    }

    static public VectorImpl_Pair_Type_String__long_ create (CallContext context) {
        return new VectorImpl_Pair_Type_String__long_(context);
    }

    protected VectorImpl_Pair_Type_String__long_ (CallContext context, java.util.Vector vector) {
        this.vector = vector;
    }

    static public VectorImpl_Pair_Type_String__long_ create (CallContext context, java.util.Vector vector) {
        return new VectorImpl_Pair_Type_String__long_(context, vector);
    }
    ...
    public Pair_Type_String_ get          (CallContext context, long index) throws DoesNotExist {
        try {
            return (Pair_Type_String_) vector.elementAt((int) index);
    ...
    public boolean contains(CallContext context, Pair_Type_String_ item) {
        return this.vector.contains(item);
    }

    public boolean removeFirst(CallContext context, Pair_Type_String_ item) {
        return this.vector.remove(item);
    }

    public void removeAll(CallContext context, Pair_Type_String_ item, VectorOptimized.Notifier<Pair_Type_String_> notifier) {
