...
public class MapImpl_TypeOrNull_String_
  implements Map_TypeOrNull_String_
{
    private java.util.Hashtable map;

    public MapImpl_TypeOrNull_String_ (CallContext context) {
        map = new java.util.Hashtable ();
    }

    public MapImpl_TypeOrNull_String_ (CallContext context, java.util.Hashtable map ) {
        this.map = map;
    }
    ...
    public TypeOrNull get     (CallContext context, String index) throws DoesNotExist {
        ...
        return (TypeOrNull) item;
    }

    public TypeOrNull tryGet  (CallContext context, String index) {
        TypeOrNull typeditem = (TypeOrNull) map.get(index);
        return typeditem;
    }
    ...
    public MapReferenceToMember_TypeOrNull_String_ getReference (CallContext context, String index) throws DoesNotExist {
        ...
        return new MapReferenceToMember_TypeOrNull_String_(context, this, index);
    }
    ...
    public IteratorItemIndex_TypeOrNull_String_ getNavigator (CallContext context) {
        return new MapIteratorImpl_TypeOrNull_String_ (context, map, this);
    }
