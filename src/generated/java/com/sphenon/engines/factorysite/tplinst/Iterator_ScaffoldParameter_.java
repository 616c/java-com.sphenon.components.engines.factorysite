...
public interface Iterator_ScaffoldParameter_
    extends com.sphenon.basics.many.Iterator<ScaffoldParameter>
{
    ...
    public Iterator_ScaffoldParameter_ clone(CallContext context);
}
