...
public class VectorReferenceToMember_ParEntry_long_
    implements ReferenceToMember_ParEntry_long_ReadOnlyVector_ParEntry_long__
{
    private ReadOnlyVector_ParEntry_long_ vector;
    private long                          index;

    public VectorReferenceToMember_ParEntry_long_ (CallContext context, ReadOnlyVector_ParEntry_long_ vector, long index) {
        this.vector = vector;
        this.index  = index;
    ...
    public ReadOnlyVector_ParEntry_long_ getContainer (CallContext context) {
        return this.vector;
    }
    ...
    public ParEntry get (CallContext context) {
            try {
    ...
    public boolean equals (Object object) {
        ...
        if (! (object instanceof VectorReferenceToMember_ParEntry_long_)) return false;
        if (((VectorReferenceToMember_ParEntry_long_) object).vector != this.vector) return false;
        if (((VectorReferenceToMember_ParEntry_long_) object).index  != this.index ) return false;
        return true;
    }
