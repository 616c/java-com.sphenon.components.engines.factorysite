...
import com.sphenon.basics.many.returncodes.*;
 ...
 public class Pair_DataSource_String_ {
    private DataSource item1;
    private String item2;

    public Pair_DataSource_String_ (CallContext context, DataSource item1, String item2) {
        this.item1 = item1;
        this.item2 = item2;
    }

    public DataSource getItem1(CallContext context) { return item1; }
    
    public void setItem1(CallContext context, DataSource item1) { this.item1 = item1; }
