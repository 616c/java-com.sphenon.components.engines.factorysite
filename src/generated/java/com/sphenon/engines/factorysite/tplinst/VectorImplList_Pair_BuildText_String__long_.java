...
public class VectorImplList_Pair_BuildText_String__long_
  implements Vector_Pair_BuildText_String__long_, VectorImplList, Dumpable, ManagedResource {
    protected java.util.List vector;

    protected VectorImplList_Pair_BuildText_String__long_ (CallContext context) {
        vector = new java.util.ArrayList ();
    }

    static public VectorImplList_Pair_BuildText_String__long_ create (CallContext context) {
        return new VectorImplList_Pair_BuildText_String__long_(context);
    }

    protected VectorImplList_Pair_BuildText_String__long_ (CallContext context, java.util.List vector) {
        this.vector = vector;
    }

    static public VectorImplList_Pair_BuildText_String__long_ create (CallContext context, java.util.List vector) {
        return new VectorImplList_Pair_BuildText_String__long_(context, vector);
    }

    public Pair_BuildText_String_ get          (CallContext context, long index) throws DoesNotExist {
        try {
            return (Pair_BuildText_String_) vector.get((int) index);
