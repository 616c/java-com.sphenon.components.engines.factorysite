...
public class VectorReferenceToMember_Scaffold_long_
    implements ReferenceToMember_Scaffold_long_ReadOnlyVector_Scaffold_long__
{
    private ReadOnlyVector_Scaffold_long_ vector;
    private long                          index;

    public VectorReferenceToMember_Scaffold_long_ (CallContext context, ReadOnlyVector_Scaffold_long_ vector, long index) {
        this.vector = vector;
        this.index  = index;
    ...
    public boolean equals (Object object) {
        ...
        if (! (object instanceof VectorReferenceToMember_Scaffold_long_)) return false;
        if (((VectorReferenceToMember_Scaffold_long_) object).vector != this.vector) return false;
        if (((VectorReferenceToMember_Scaffold_long_) object).index  != this.index ) return false;
        return true;
    }
