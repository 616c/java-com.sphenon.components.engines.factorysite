...
public class Factory_Map_DataSource_String_
{
    private String[] names;
    private DataSource[] values;

    public Map_DataSource_String_ create (CallContext context) {
        Map_DataSource_String_ map = new MapImpl_DataSource_String_(context);
