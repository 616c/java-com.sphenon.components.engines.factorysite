...
public class VectorImpl_DataSource_BuildTextXMLPreprocessor_long_
  implements Vector_BuildTextXMLPreprocessor_long_, ManagedResource {
    private com.sphenon.basics.data.DataSource<Vector> vector_source;

    public VectorImpl_DataSource_BuildTextXMLPreprocessor_long_ (CallContext context, com.sphenon.basics.data.DataSource<Vector> vector_source) {
        this.vector_source = vector_source;
    }

    static public VectorImpl_DataSource_BuildTextXMLPreprocessor_long_ create (CallContext context, com.sphenon.basics.data.DataSource<Vector> vector_source) {
        return new VectorImpl_DataSource_BuildTextXMLPreprocessor_long_(context, vector_source);
    }

    public BuildTextXMLPreprocessor get          (CallContext context, long index) throws DoesNotExist {
        try {
            return (BuildTextXMLPreprocessor) vector_source.get(context).elementAt((int) index);
