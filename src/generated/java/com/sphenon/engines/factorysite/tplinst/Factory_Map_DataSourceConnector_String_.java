...
public class Factory_Map_DataSourceConnector_String_
{
    private String[] names;
    private DataSourceConnector[] values;

    public Map_DataSourceConnector_String_ create (CallContext context) {
        Map_DataSourceConnector_String_ map = new MapImpl_DataSourceConnector_String_(context);
    ...
    public void set_ParametersAtOnce(CallContext call_context, String[] names, DataSourceConnector[] values) {
