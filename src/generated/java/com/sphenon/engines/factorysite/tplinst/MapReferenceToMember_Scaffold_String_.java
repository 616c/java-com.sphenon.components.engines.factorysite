...
public class MapReferenceToMember_Scaffold_String_
    implements ReferenceToMember_Scaffold_String_Map_Scaffold_String__
{
    private Map_Scaffold_String_    map;
    private String                  index;

    public MapReferenceToMember_Scaffold_String_ (CallContext context, Map_Scaffold_String_ map, String index) {
        this.map    = map;
        this.index  = index;
    ...
    public Map_Scaffold_String_ getContainer (CallContext context) {
        return this.map;
    }
    ...
    public Scaffold get (CallContext context) {
        try {
    ...
    public boolean equals (Object object) {
        ...
        if (! (object instanceof MapReferenceToMember_Scaffold_String_)) return false;
        if (((MapReferenceToMember_Scaffold_String_) object).map != this.map) return false;
        if (((MapReferenceToMember_Scaffold_String_) object).index  != this.index ) return false;
        return true;
    }
