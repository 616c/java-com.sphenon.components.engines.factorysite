...
public class MapIteratorImpl_TypeOrNull_String_
    implements IteratorItemIndex_TypeOrNull_String_
{
    private Map_TypeOrNull_String_ map_t;
    private java.util.Hashtable map;
    private java.util.Set entry_set;
    private java.util.Iterator iterator;
    private java.util.Map.Entry me;

    public MapIteratorImpl_TypeOrNull_String_ (CallContext context, java.util.Hashtable map, Map_TypeOrNull_String_ map_t) {
        this.map_t = map_t;
        this.map = map;
    ...
    public TypeOrNull getCurrent (CallContext context) throws DoesNotExist {
        if ( ! canGetCurrent(context)) { DoesNotExist.createAndThrow(context); }
        return (TypeOrNull) me.getValue();
    }

    public TypeOrNull tryGetCurrent (CallContext context) {
        if ( ! canGetCurrent(context)) { return null; }
        return (TypeOrNull) me.getValue();
    }
    ...
    public Reference_TypeOrNull_ getReferenceToCurrent (CallContext context) throws DoesNotExist {
        return map_t.getReference(context, this.getCurrentIndex(context));
    }

    public Reference_TypeOrNull_ tryGetReferenceToCurrent (CallContext context) {
        if ( ! canGetCurrent(context)) { return null; }
        return map_t.tryGetReference(context, this.tryGetCurrentIndex(context));
    }

    public MapIteratorImpl_TypeOrNull_String_ clone(CallContext context) {
