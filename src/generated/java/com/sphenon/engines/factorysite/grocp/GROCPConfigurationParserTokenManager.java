/* Generated By:JavaCC: Do not edit this line. GROCPConfigurationParserTokenManager.java */
...
public class GROCPConfigurationParserTokenManager implements GROCPConfigurationParserConstants
{
...
"", null, "\12", null, null, null, null, "\133", "\135", "\57", "\54", "\72", 
"\75", null, };
...
public GROCPConfigurationParserTokenManager(SimpleCharStream stream){
   if (SimpleCharStream.staticFlag)
      throw new Error("ERROR: Cannot use a static CharStream class with a non-static lexical analyzer.");
   input_stream = stream;
}
public GROCPConfigurationParserTokenManager(SimpleCharStream stream, int lexState){
   this(stream);
   SwitchTo(lexState);
}
