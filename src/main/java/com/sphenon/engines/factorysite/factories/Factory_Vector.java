...
public class Factory_Vector {

    private String[] names;
    private Object[] values;

    protected java.util.Vector instance;

    public java.util.Vector precreate (CallContext context) {
        return this.instance = new java.util.Vector();
    }

    public java.util.Vector create (CallContext context) {
        java.util.Vector list = (this.instance != null ? this.instance : new java.util.Vector());
        this.instance = null;
