...
public class DIAState extends DIAItem {

    protected DIAState (CallContext context, XMLNode node, DIADiagram diagram, DIAItem parent) {
        super(context, node, null, ItemType.State, diagram, parent);
    }
