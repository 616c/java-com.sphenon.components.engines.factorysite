...
public class BuildTextDiagramFactory implements BuildTextFactory {

    static final public Class _class = BuildTextDiagramFactory.class;
    ...
    public BuildTextDiagramFactory (CallContext context, Data_MediaObject data, Map<String, BuildText> bt_by_oid_override, String signature_override) throws InvalidDocument {
        this(context, parse(context, data), bt_by_oid_override, signature_override);
    }

    public BuildTextDiagramFactory (CallContext context, InputStream input_stream, Map<String, BuildText> bt_by_oid_override, String signature_override) throws InvalidDocument {
        this(context, parse(context, input_stream), bt_by_oid_override, signature_override);
    }

    public BuildTextDiagramFactory (CallContext context, File file, Map<String, BuildText> bt_by_oid_override, String signature_override) throws InvalidDocument {
        this(context, parse(context, file), bt_by_oid_override, signature_override);
    }

    public BuildTextDiagramFactory (CallContext context, String md_string, Map<String, BuildText> bt_by_oid_override, String signature_override) throws InvalidDocument {
        this(context, parse(context, md_string), bt_by_oid_override, signature_override);
    }

    static protected BuildText parse(CallContext context, Data_MediaObject data) throws InvalidDocument {
        try {
            return DIADiagram.build(context, XMLNode.createXMLNode(context, data));
        } catch (InvalidXML ix) {
            InvalidDocument.createAndThrow(context, ix, "Could not parse diagram xml for factory site");
    ...
    static protected BuildText parse(CallContext context, InputStream input_stream) throws InvalidDocument {
        try {
            return DIADiagram.build(context, XMLNode.createXMLNode(context, input_stream, "<stream>"));
        } catch (InvalidXML ix) {
            InvalidDocument.createAndThrow(context, ix, "Could not parse diagram xml for factory site");
            throw (InvalidDocument) null; // compiler insists
        }
    ...
    static protected BuildText parse(CallContext context, File file) throws InvalidDocument {
        try {
            return DIADiagram.build(context, XMLNode.createXMLNode(context, file));
        } catch (InvalidXML ix) {
            InvalidDocument.createAndThrow(context, ix, "Could not parse diagram xml for factory site");
            throw (InvalidDocument) null; // compiler insists
        }
    ...
    static protected BuildText parse(CallContext context, String md_string) throws InvalidDocument {
        try {
            return DIADiagram.build(context, XMLNode.createXMLNode(context, md_string, "<string>"));
        } catch (InvalidXML ix) {
            InvalidDocument.createAndThrow(context, ix, "Could not parse diagram xml for factory site");
            throw (InvalidDocument) null; // compiler insists
        }
    ...
    protected BuildTextDiagramFactory (CallContext context, BuildText diaocp, Map<String, BuildText> bt_by_oid_override, String signature_override) throws InvalidDocument {
