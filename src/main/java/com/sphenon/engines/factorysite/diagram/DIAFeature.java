...
abstract public class DIAFeature extends DIAItem {

    protected DIAFeature (CallContext context, XMLNode node, String[] layers, ItemType item_type, DIADiagram diagram, DIAItem parent) {
        super(context, node, layers, item_type, diagram, parent);
    }
}
