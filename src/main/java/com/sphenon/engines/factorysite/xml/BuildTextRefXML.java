...
public class BuildTextRefXML extends BuildTextXMLBaseImpl implements BuildTextRef, Dumpable {

    public BuildTextRefXML (CallContext context, Element node, String source_location_info) {
