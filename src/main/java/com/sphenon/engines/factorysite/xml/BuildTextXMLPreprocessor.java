...
/**
 * A preprocessor for a XML OCP input source.
 * An implementation of this class needs to be registered at the BuildTextXMLFactory.
 */

public interface BuildTextXMLPreprocessor {
    /**
     ...
     */
    public Document getDocument(CallContext context, XMLInputSource input_source);
}
