...
public class BuildTextNullXML extends BuildTextXMLBaseImpl implements BuildTextNull {

    public BuildTextNullXML (CallContext context, Element node, String source_location_info) {
