...
public class BuildTextNullYAML extends BuildTextYAMLBaseImpl implements BuildTextNull {

    public BuildTextNullYAML (CallContext context, Object node, BuildTextYAMLMetainfo meta, String source_location_info) {
