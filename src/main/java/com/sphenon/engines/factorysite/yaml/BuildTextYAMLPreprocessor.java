...
/**
 * A preprocessor for a YAML OCP input source.
 * An implementation of this class needs to be registered at the BuildTextYAMLFactory.
 */

public interface BuildTextYAMLPreprocessor {
    // /**
    ...
    //  */
    // public Document getDocument(CallContext context, YAMLInputSource input_source);
}
