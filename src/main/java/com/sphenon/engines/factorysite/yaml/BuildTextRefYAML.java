...
public class BuildTextRefYAML extends BuildTextYAMLBaseImpl implements BuildTextRef, Dumpable {

    public BuildTextRefYAML (CallContext context, Object node, BuildTextYAMLMetainfo meta, String source_location_info) {
