...
public class GenericClass_Map implements GenericClass {
    static public class Factory implements GenericClass.Factory {
        ...
        public Type getClassType(CallContext context, Type type) {
            return TypeManager.getParametrised(context, GenericClass_Map.class, type);
        }
    }
}
