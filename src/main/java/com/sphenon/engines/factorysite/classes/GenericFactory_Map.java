...
public class GenericFactory_Map implements GenericFactory {
    static public class Factory implements GenericFactory.Factory {
        ...
        public Type getFactoryType(CallContext context, Type type) {
            return TypeManager.getParametrised(context, GenericFactory_Map.class, type);
        }
    }
}
